...
class AlienInvasion:
	...
	def __init__(self):
		"""Intiliaze the game, and create game resources."""
		pygame.init()
	...
	def _update_bullets(self):
		...
		self.bullets.update()
		#Get rid of bullets that have disaapeared.
	...
	def _check_aliens_bottom(self):
		"""Check if any alien shave reached the bottom of the screen. """
